...
class V2VVoxelization(object):
    def __init__(self, cubic_size, augmentation=True): #augmentation 할것이냐 말것이냐?
        self.cubic_size = cubic_size
        self.cropped_size, self.original_size = 88, 96
        self.sizes = (self.cubic_size, self.cropped_size, self.original_size) # 200, 88 , 96
        self.pool_factor = 2
        self.std = 1.7 #표준편차
    ...
    def __call__(self, sample):
        ...
        # ax.voxels(heatmap[0],facecolors='#ff0000', edgecolors='#ff0000', antialiased=True)
